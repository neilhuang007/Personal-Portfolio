...
function openProjectWindow(projectData) {
    ...
    projectWindow.className = `project-window active ${projectData.featured ? 'featured-window' : ''}`;
    ...
    // Generate tags HTML
    const tagsHTML = projectData.tags ? projectData.tags.map(tag =>
        `<span class="project-tag ${tag.type || ''}">${tag.label}</span>`
    ).join('') : '';

    projectWindow.innerHTML = `
        <div class="project-window-header">
            <div class="project-window-title">
                ${projectData.featured ? '<span class="featured-badge">★ FEATURED</span>' : ''}
                ${projectData.name}
            </div>
        ...
        <div class="project-content">
            ...
            <div class="project-article">
                ${parseMarkdown(projectData.content || generateDefaultContent(projectData.name, projectData.description))}
            </div>
        ...
        ${projectData.featured ? '<div class="featured-glow"></div>' : ''}
    `;
...
function generateDefaultContent(name, description) {
